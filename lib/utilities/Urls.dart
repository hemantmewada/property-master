...
class Urls {
  ...
  static const createBusinessPartnerUrl = "${baseUrl}create_business_patner";
  static const employeeCountUrl = "${baseUrl}employee_count";
  static const employeeListListUrl = "${baseUrl}employee_list";
  static const updateProfileImageUrl = "${baseUrl}update_profile_image";
