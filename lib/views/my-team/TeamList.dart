                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: CachedNetworkImage(
                                        imageUrl: employeeList![index].profileImg!,
                      ...
                      InkWell(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                const Text("Total Properties",style: TextStyle(fontSize: 16.0,),),
                                ...
                                Container(
                                  ...
                                  child: Text(employeeList![index].totalProperty.toString(),style: const TextStyle(color: AppColors.white,fontSize: 16.0,),),
                                ),
                              ],
                            ),
                          ],
